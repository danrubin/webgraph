...
$counterfile = 'inc/counter_sonyicons.txt';
...
?><html>
<head>
<title>webgraph :: Sony Cli&eacute; Icons for Mac</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="top"><a href="http://www.webgraph.com/"><img src="resources/webgraph.gif" width="113" height="53" border="0" alt="webgraph"></a><br>
      <b><font color="#679D0F">Mac OS</font></b> <font color="#333333">|</font> 
      <a href="index_pc.php">Windows XP</a><br>
      <br>
      <table width="500" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td align="center" valign="top" colspan="3"><img src="resources/top.gif" width="500" height="37"></td>
        </tr>
        <tr> 
            ...
            <table width="478" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="208" align="left" valign="top"> 
                  <font face="Verdana, Arial, Helvetica, sans-serif" size="2"><p><font face="Verdana, Arial, Helvetica, sans-serif" size="5" color="#666666"><b>Version 
                    1.5</b></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><b><br>
                    <!--<font color="#999999">Updated 04.19.2002</font></b></font><br>-->
                    <img src="resources/preview.jpg" width="208" height="140" alt="Icon Preview" vspace="3"><br>
                    <b><br>
                  ...
                  <ul>
                    ...
                    <li><font color="#9999CC">Sony Memory Stick (64MB, 32MB, 16MB, 8MB, 4MB)</font></li>
                    <li><font color="#9999CC">MagicGate Memory Stick (64MB, 32MB, 16MB, 8MB)</font></li>
                  </ul>
                  </font>
                    <p><font color="#9999CC">1.1 - Added the following icons:</font></p>
                  <font size="1">
                  <ul>
                    <li><font color="#9999CC">Clie 700 w/Cradle</font></li>
                    <li><font color="#9999CC">Sony Clie Folder</font></li>
                    <li><font color="#9999CC">Memory Stick Logo (black)</font></li>
                    <li><font color="#9999CC">Memory Stick Logo (white)</font></li>
                    <li><font color="#9999CC">Sony Memory Stick Camera</font></li>
                    <li><font color="#9999CC">MagicGate Memory Stick (128MB)</font></li>
                  </ul>
                  </font>
                ...
                <td width="260" align="left" valign="top"> 
                  <p><img src="resources/shim.gif" height="35" width="1"><br>
                    ...
                    Cli&eacute; Icons for Mac</font></b><font color="#666666"><br>
                    This free set of icons was designed to fill the void in the 
                    Mac icon world for users of Sony Cli&eacute; and other Sony 
                    electronics. The set is </font></font><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#666666">compatible 
                    with Mac OS 8.5 or higher, including OS X.<br>
                    <br>
                    <b>Icon List</b><br>
                    Cli&eacute; 700-Series, Cli&eacute; 700 w/Cradle, Cli&eacute; NR70 (Closed), Cli&eacute; NR70 (Open), Cli&eacute; NR70v (Closed), Cli&eacute; NR70v (Clamshell), Cli&eacute; NR70 (Open), Sony Cli&eacute; Folder, Sony Memory Stick Camera, Memory Stick (128MB, 64MB, 32MB, 16MB, 8MB, 4MB), MagicGate Memory Stick (128MB, 64MB, 32MB, 16MB, 8MB), Memory Stick Logo (black), Memory Stick Logo (white), Palm Logo, CyberShot F505V<br>
                    <br>
                    <b>Download</b><br>
                    <a href="files/SonyClieIconsMac_v1.5.sit.bin">Sony Cli&eacute; 
                    Icons for Mac v1.5</a> (.bin)<br>
                    <a href="files/SonyClieIconsMac_v1.5.sit.hqx">Sony Cli&eacute; 
                    Icons for Mac v1.5</a> (.hqx)<br>
                    <br>
                    <b>Contact<br>
